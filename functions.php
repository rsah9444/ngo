...
function ngo_main_function(){
    ...
    wp_enqueue_script( 'jquery',get_template_directory_uri().'./assets/vendor/jquery/jquery.min.js', array('jquery'), true );
    ...
    wp_enqueue_script( 'jquery-easing',get_template_directory_uri().'./assets/vendor/jquery.easing/jquery.easing.min.js', array('jquery'), true );
    wp_enqueue_script( 'validate',get_template_directory_uri().'./assets/vendor/php-email-form/validate.js', array('jquery'), true );
    wp_enqueue_script( 'jqyery-stick',get_template_directory_uri().'./assets/vendor/jquery-sticky/jquery.sticky.js', array('jquery'), true );
    wp_enqueue_script( 'venobox',get_template_directory_uri().'./assets/vendor/venobox/venobox.min.js', array('jquery'), true );
    wp_enqueue_script( 'waypoints',get_template_directory_uri().'./assets/vendor/waypoints/jquery.waypoints.min.js', array('jquery'), true );
    wp_enqueue_script( 'counter',get_template_directory_uri().'./assets/vendor/counterup/counterup.min.js', array('jquery'), true );
    wp_enqueue_script( 'isotope',get_template_directory_uri().'./assets/vendor/isotope-layout/isotope.pkgd.min.js', array('jquery'), true );
    wp_enqueue_script( 'aosjs',get_template_directory_uri().'./assets/vendor/aos/aos.js', array(), true );
